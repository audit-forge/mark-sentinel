...
Generated: 2026-04-29T11:23:46Z
...
- **AI-AGENT-001 — Tool/Function Permissions Follow Least Privilege** — 🔴  
  ...
  - Framework mappings: OWASP LLM/LLM06, FedRAMP/AC-6, NIST AI RMF/GOVERN 6.1

- **AI-AGENT-002 — Agent Cannot Take Destructive Actions Without Confirmation** — 🔴  
  - Description: No agent configuration file found.
  - Framework mappings: OWASP LLM/LLM06, FedRAMP/AC-3, NIST AI RMF/GOVERN 6.1
...
- **AI-AGENT-003 — Agent Memory/Context Cannot Be Poisoned by External Input** — 🔴  
  ...
  - Framework mappings: OWASP LLM/LLM01, FedRAMP/SI-7, NIST AI RMF/MANAGE 1.3
...
- **AI-AGENT-005 — Agent Action Logs Captured and Auditable** — 🔴  
  ...
  - Framework mappings: OWASP LLM/LLM06, FedRAMP/AU-2, NIST AI RMF/MEASURE 2.5

- **AI-AGENT-006 — Agent Cannot Exfiltrate Data to Unapproved Endpoints** — 🔴  
  - Description: No agent configuration found.
  - Framework mappings: OWASP LLM/LLM06, FedRAMP/AC-4, FedRAMP/SC-7, NIST AI RMF/MANAGE 1.3

### AI-DEPLOY (6)

- **AI-DEPLOY-001 — API Keys Not Exposed** — ✅  
  - Description: No API keys detected in source files. .gitignore protects .env files.
  - Framework mappings: OWASP LLM/LLM07, FedRAMP/IA-5, NIST AI RMF/MANAGE 2.2
...
- **AI-DEPLOY-002 — No Hardcoded Credentials in Model Config** — ✅  
  ...
  - Framework mappings: OWASP LLM/LLM07, FedRAMP/IA-5, FedRAMP/CM-6, NIST AI RMF/MANAGE 2.2
...
- **AI-DEPLOY-003 — Logging Enabled and Retained** — ✅  
  ...
  - Framework mappings: OWASP LLM/LLM10, FedRAMP/AU-2, FedRAMP/AU-11, NIST AI RMF/MEASURE 2.5
...
- **AI-DEPLOY-004 — Access Controls on AI Endpoint** — ✅  
  ...
  - Framework mappings: OWASP LLM/LLM07, FedRAMP/AC-3, NIST AI RMF/GOVERN 1.1
...
- **AI-DEPLOY-005 — TLS/HTTPS Enforced on All AI Connections** — ✅  
  ...
  - Framework mappings: OWASP LLM/LLM08, FedRAMP/SC-8, NIST AI RMF/MANAGE 2.2
...
- **AI-DEPLOY-006 — Rate Limiting Configured** — ✅  
  ...
  - Framework mappings: OWASP LLM/LLM10, FedRAMP/SC-5, NIST AI RMF/MANAGE 2.2
...
5. M.A.R.K. Sentinel provides a policy template in docs/SMB_GUIDE.md.
  - Framework mappings: OWASP LLM/LLM10, FedRAMP/PL-1, NIST AI RMF/GOVERN 1.1, EU AI Act/Article 9
...
5. Document the deletion process for AI data in your data subject rights procedure.
  - Framework mappings: OWASP LLM/LLM02, FedRAMP/SI-12, FedRAMP/AU-11, NIST AI RMF/GOVERN 1.1, GDPR/Article 5(1)(e)
...
5. Who needs to be notified? (legal, affected users, regulators if required)
  - Framework mappings: OWASP LLM/LLM10, FedRAMP/IR-1, FedRAMP/IR-4, NIST AI RMF/MANAGE 4.1
...
4. Track AI-human divergence rate: how often do humans override the AI? A 0% rate suggests rubber-stamping.
  - Framework mappings: OWASP LLM/LLM06, FedRAMP/PL-1, NIST AI RMF/GOVERN 6.1, EU AI Act/Article 14
...
4. Review quarterly — remove decommissioned systems, add newly discovered shadow AI.
  - Framework mappings: OWASP LLM/LLM10, FedRAMP/CM-8, NIST AI RMF/GOVERN 2.2, EU AI Act/Article 60
...
3. Limit what retrieved content can instruct the model to do (e.g., it cannot modify system behavior).
  - Framework mappings: OWASP LLM/LLM05, OWASP Agentic/OAGNT-03, FedRAMP/SI-10, NIST AI RMF/MEASURE 2.6
...
- **AI-INP-005 — Input Length and Token Limits Enforced** — ✅  
  ...
  - Framework mappings: OWASP LLM/LLM10, FedRAMP/SI-10, NIST AI RMF/MANAGE 2.2
...
- **AI-OUT-001 — Model Does Not Return Training Data on Request** — 🟡  
  - Description: This check requires a live AI connection to send adversarial probes. Run with --mode api or --mode local to evaluate.
  - Remediation: Rerun with --mode api --endpoint <url> or --mode local --ollama-host http://localhost:11434
  - Framework mappings: OWASP LLM/LLM02, FedRAMP/AC-4, NIST AI RMF/MEASURE 2.5
...
- **AI-OUT-005 — Output Sanitization Before Passing to Downstream Systems** — 🔴  
  ...
  - Framework mappings: OWASP LLM/LLM05, FedRAMP/SI-10, NIST AI RMF/MEASURE 2.5
...
4. Subscribe to provider security advisories for models in use.
  - Framework mappings: OWASP LLM/LLM03, FedRAMP/SA-12, FedRAMP/CM-8, NIST AI RMF/GOVERN 2.2
...
- **AI-SUPPLY-002 — Model Source Verified (Not Tampered or Poisoned)** — ✅  
  ...
  - Framework mappings: OWASP LLM/LLM03, OWASP LLM/LLM04, FedRAMP/SA-12, FedRAMP/SI-7, NIST AI RMF/MAP 1.5
...
Run 'pip audit' or 'npm audit' to check for known vulnerabilities.
  - Framework mappings: OWASP LLM/LLM03, FedRAMP/SA-12, FedRAMP/CM-7, NIST AI RMF/GOVERN 2.2
...
Match against your approved AI service inventory.
  - Framework mappings: OWASP LLM/LLM03, FedRAMP/CM-7, NIST AI RMF/GOVERN 2.2
...
- **AI-SUPPLY-005 — Model Version Pinned (Not Floating Latest)** — ✅  
  ...
  - Framework mappings: OWASP LLM/LLM03, FedRAMP/CM-6, NIST AI RMF/GOVERN 2.2
