...
def build(root: pathlib.Path) -> bytes:
    ...
    macos = ("<h4>Server setup</h4>"
             "<p>Run once on the machine that will host the dashboard:</p>"
             ...
             "# Academy:        http://localhost:7331/academy</code></pre>"
             "<h4>Agent install</h4>"
    ...
    windows = ("<h4>Server setup</h4>"
               "<p>Run once in PowerShell as Administrator on the dashboard machine:</p>"
               "<pre><code>git clone https://github.com/audit-forge/mark-sentinel.git C:\\Sentinel\n"
               "Set-Location C:\\Sentinel\n"
