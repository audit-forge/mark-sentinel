...
def build(root: pathlib.Path) -> bytes:
    ...
    macos = ("<h4>Server setup (run once)</h4>"
             ...
             "<pre><code># Run in background (terminal stays free, survives terminal close)\n"
             "nohup /opt/sentinel/venv/bin/python /opt/sentinel/server.py --no-browser > /var/log/sentinel-server.log 2>&1 &\n\n"
